/* ===========================
   AYARLAR – Firestore Entegre (v11.2)
   =========================== */

console.log("[settings] settings.js yüklendi (v11.2)");
...
function materializeData(d) {
  ...
  return {
    business: { name, address: { city: cityVal, district: districtVal, hood: hoodVal, buildingNo: buildingVal, mapUrl: mapLink } },
    services: uniq,
  };
}
