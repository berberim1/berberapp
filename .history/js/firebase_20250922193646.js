// js/firebase.js  (v4.6 — App Check kaldırıldı, Storage bucket + emulator opsiyonları korunuyor)
...
/* ========= App Check =========
   KALDIRILDI: reCAPTCHA v3 sağlayıcısı ve debug token kullanımı.
   Projede bu export'a referans varsa kırılmasın diye null döndürüyoruz. */
