/* Gün + Hafta görünümü (arka karartma/overlay YOK) */
...
function openModal({ id, panelClassOpen='open', ariaTargetId }) {
  // hiçbir yerde backdrop/overlay YOK
  closeAllModals();
...
// “Admin / Owner / Sahip / owner adı” → tek isim
