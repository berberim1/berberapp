/* ===========================
   AYARLAR – Firestore Entegre (v11.5)
   - business.about & business.phone
   - Storage upload iyileştirmeleri (contentType, hata logları)
   - UID tekil (duplicate declaration fix)
   =========================== */

console.log("[settings] settings.js yüklendi (v11.5)");
...
// Doğru bucket mı? Konsolda 'gs://my-barber-system.firebasestorage.app/...' görmelisin
try {
...
(async () => {
  try {
    ...
    // Sadece aktif sayfa mor, diğerleri opak
