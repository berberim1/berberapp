...
function fillCities() {
  ...
  city.disabled = true; // sadece İstanbul kullanılacak
}
...
async function prefillFromDoc(d) {
  ...
  // (opsiyonel) kullanıcının adını rail içindeki yere yaz
