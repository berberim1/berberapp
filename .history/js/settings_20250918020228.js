/* ===========================
   AYARLAR – Firestore Entegre (v11.3)
   - business.about & business.phone eklendi
   =========================== */

console.log("[settings] settings.js yüklendi (v11.3)");
...
function openPickerModal() {
  ...
  document.body.style.overflow = "hidden"; // arkayı kaydırmayı kapat
  renderPicker();
  pickerSearch?.focus();
}
...
function buildUpdatesForFirestore() {
  ...
  // Telefonu boşluklardan arındır
  const phoneVal = (contactPhone?.value || "").replace(/\s+/g, "").trim();
