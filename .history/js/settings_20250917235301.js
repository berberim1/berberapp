/* ===========================
   AYARLAR – Firestore Entegre (Full + Debug v10)
   - bar-menu.html import (rail + sb- modal)
   - eski bm-* modal bağları kaldırıldı
   =========================== */

console.log("[settings] settings.js yüklendi (v10)");
...
(async () => {
  try {
    // Eski aside.rail varsa kaldır (çift nav olmasın)
...
async function prefillFromDoc(d) {
  ...
  // (opsiyonel) kullanıcının adını sayfada göstermek istersen:
