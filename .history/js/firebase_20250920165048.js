// js/firebase.js  (v4.3 — correct Storage bucket + App Check + emu opsiyonları)
...
/* --- Storage ---
   ÖNEMLİ: explicit bucket ile doğru endpoint’e gider (gs://<project>.appspot.com). */
export const storage = getStorage(app, "gs://my-barber-system.appspot.com"); // ← doğru bucket
