/* ===========================
   AYARLAR – Firestore Entegre (v12.0 DESKTOP-ONLY)
   - Mobil davranış yok; mobil için mobil_settings.js kullanılacak
   =========================== */

"use strict";

console.log("[settings] settings.js yüklendi (v12.0 desktop-only)");
...
function attachDirtyWatchers() {
  ...
  // Mobil scriptlerin kirlenmeyi tetiklemesi için küçük bir köprü (event tabanlı)
  document.addEventListener("settings:mark-dirty", () => setDirty(true));
}
...
const DATA = {
  İstanbul: {
    ...
    Üsküdar: [
      ...
      "Küçük Çamlıca","Küçüksu","Mehmet Akif Ersoy","Mimar Sinan","Salacak","Selami Ali",
      "Sultantepe","Ünalan","Valide-i Atik","Yavuztürk","Zeynep Kamil"
    ],
  },
};
const city = $("#city"),
...
/* ===========================
   Görsel (çoklu) + Lightbox (masaüstü ölçüler)
   =========================== */
...
(function setupImageViewer() {
  ...
  function ensure() {
    ...
    ov.addEventListener("click", (e) => {
      if (e.target.hasAttribute("data-close")) closeImageViewer();
    });
    document.addEventListener("keydown", (e) => {
...
/* ===========================
   Minimal dışa açılan API (mobil scriptler kullanabilsin)
   =========================== */
window.SettingsAPI = Object.freeze({
